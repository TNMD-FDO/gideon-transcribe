...
| Summaries describe the moments first | On or Off | On (Off in v1.41.0) | 4 (v1.41.0; the rule and the default from v1.43.0) | Whether Summarise this video starts with its tick, Look at the picture first, ticked, while fewer moments are described than Enough moments for a video summary and something is left to describe. Ticked, the summary describes the recording at intervals before it writes, so it can say what was seen as well as what was said; one call per interval. Greyed while Moments is Off. | The next summary dialog opened. |
| Enough moments for a video summary | 0 to 200 | 10 | 4 (v1.43.0) | When at least this many moments are described already, Look at the picture first starts unticked and the summary draws on what there is. 0 means it always starts ticked. Greyed while Moments is Off. | The next summary dialog opened. |
