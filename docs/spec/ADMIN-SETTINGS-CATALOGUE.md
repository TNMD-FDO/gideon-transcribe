...
- From the Moments chapter 8 (v1.54.0, the Vision page): Vision runs, Overnight from and until, Enrich with vision starts ticked, Exports carry what the camera showed; the three mail templates Vision done, Vision requested and Vision allowed on the Email page, and Batch finished's {prepared} line reworded; every Moments setting still in force moved from the AI assistant page to the Vision page with its key unchanged (Moments renamed Vision, Moments in answers renamed Descriptions reach summaries and chat, the Moment prefix renamed Description); Moment clip length, Look closer frame height and Look closer frames withdrawn, their stored values ignored.
