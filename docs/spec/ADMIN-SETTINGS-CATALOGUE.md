...
| Interpreter (Features page; **not yet built**, Phase 3 chapter 3) | On or Off; greyed while Live recording is Off or the AI assistant has no engine | Off | 3 | People may hold an interpreted Session from the New recording page: heard, translated, and spoken on the server, kept as a Recording in both languages. | At once. Off hides the style; a Session in progress finishes. |
| Interpreter page, ten settings (**not yet built**): Languages offered, Spoken output, When to speak, Voice per language, Speaking speed, Turn-taking, Readback, Quick phrases, The notice | see Phase 3 chapter 3's table | Spanish; Speak to the visitor only; As soon as ready; the first installed Voice; Normal; Automatic; On; the six shipped phrases; the shipped notice | 3 | How a Session hears, speaks, and takes turns, and what it says to the Visitor. | At once; a Session in progress keeps the settings it started with. |
