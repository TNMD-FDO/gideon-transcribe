...
| Turn-taking (Interpreter page; key `interpreter_turn_taking`) | `automatic`, `hold` | `automatic` | 3 | Whether a Turn ends at a pause with the language heard naming the side, or only by a held button. | The next Session. |
