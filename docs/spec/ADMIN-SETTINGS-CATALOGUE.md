...
| Incident clips | On or Off; greyed while Incidents or Clips is Off | On | 7 (chapter 1, for the build) | Clip this event on the Chronology tab: one file cut from an event's cameras over its span, the incident clock and the camera ids burned in, listed with the case's other clips. The Clips page's own limits apply. | The next incident page drawn. Off hides Clip this event and keeps every clip made. |
