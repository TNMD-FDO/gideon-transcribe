...
| Exports carry what the camera showed (Vision page) | On or Off | On | 1 (v1.54.0) | Whether a summary's and a transcript's Word and text exports carry the What the camera showed section and its legend. Off leaves the descriptions in the app only. | The next export. |
