...
- **2026-09-25, v1.86.2.** Chapter 3's dashboard line: "proposed events waiting" joins the pills in the warning tone (not synced, to check, newer events, failed, deletes), because proposals wait for a person's accept or dismiss and Home's Needs you (Phase 8 chapter 13) is drawn from that tone.
